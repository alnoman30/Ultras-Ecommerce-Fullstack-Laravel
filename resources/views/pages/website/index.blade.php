                    ...
                    <div class="overflow-hidden position-relative h-100">
                        ...
                        <div class="slideshow-text container position-absolute start-50 top-50 translate-middle">
                            <h6
                                ...
                                {{ $slider->title }}</h6>
                            <h2 class="h1 fw-normal mb-0 animate animate_fade animate_btt animate_delay-5">{{ $slider->line_one }}</h2>
                            <h2 class="h1 fw-bold animate animate_fade animate_btt animate_delay-5">{{ $slider->line_two }}</h2>
                            <a href="{{ route('shop') }}"
