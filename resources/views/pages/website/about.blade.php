  ...
  <main class="pt-90">
    ...
    <section class="contact-us container">
      ...
      <div class="about-us__content pb-5 mb-5">
        <p class="mb-5">
          <img loading="lazy" class="w-100 h-auto d-block" src="{{ asset('website/assets/images/about/about-1.jpg') }}" width="1410"
            height="550" alt="" />
        </p>
        <div class="mw-930">
        ...
        <div class="mw-930 d-lg-flex align-items-lg-center">
          <div class="image-wrapper col-lg-6">
            <img class="h-auto" loading="lazy" src="{{ asset('website/assets/images/about/about-1.jpg') }}" width="450" height="500" alt="">
          </div>
